...
import projeto.recursos_alt.StdOut;
import projeto.recursos_alt.StdRandom;
...
public class FlowNetwork implements Serializable {
    ...
    public FlowNetwork(int V) {
        ...
        this.setV(V);
        this.setE(0);
        setIndegree(new int[V]);
        setAdj((Bag<FlowEdge>[]) new Bag[V]);
        for (int v = 0; v < V; v++)
            getAdj()[v] = new Bag<FlowEdge>();
    }
    ...
    public void validateVertex(int v) {
        if (v < 0 || v >= getV())
            throw new IllegalArgumentException("vertex " + v + " is not between 0 and " + (getV() -1));
    }
