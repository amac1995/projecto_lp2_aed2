/**
 * ****************************************************************************
 * Compilation: javac Bag.java Execution: java Bag < input.txt Dependencies:
 ...
 *
 * % java Bag < tobe.txt size of bag = 14 is - - - that - - be - to not or be to
 *
 *****************************************************************************
 */
package projeto;
...
import projeto.recursos.LinkedBag;
import projeto.recursos.ResizingArrayBag;
import projeto.recursos.StdIn;
