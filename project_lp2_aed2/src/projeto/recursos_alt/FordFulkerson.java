...
import projeto.FlowNetwork;
import projeto.NetworkGraph;
import projeto.recursos.Queue;
...
public class FordFulkerson {
    ...
    private double excess(NetworkGraph G, int v) {
        double excess = 0.0;
        for (FlowEdge e : G.adj(v)) {
    ...
    // return excess flow at vertex v
    private boolean isFeasible(NetworkGraph G, int s, int t) {
    ...
    // check optimality conditions
    private boolean check(NetworkGraph G, int s, int t) {
    ...
    public static void main(String[] args) {
        ...
        int s = 0, t = V-1;
        NetworkGraph G = new NetworkGraph(V, E);
        StdOut.println(G);
