...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static edu.princeton.cs.algs4.StdDraw std = new edu.princeton.cs.algs4.StdDraw();
    ...
    ***************************************************************************/
    ...
    public static void setFont(Font font) {
        ...
        edu.princeton.cs.algs4.StdDraw.font = font;
    }
...
*/
    ...
    ***************************************************************************/
    ...
    public void actionPerformed(ActionEvent e) {
        FileDialog chooser = new FileDialog(edu.princeton.cs.algs4.StdDraw.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
    ...
    ***************************************************************************/
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = edu.princeton.cs.algs4.StdDraw.userX(e.getX());
            mouseY = edu.princeton.cs.algs4.StdDraw.userY(e.getY());
            mousePressed = true;
        }
    }
    ...
    *  as an argument. It can handle action keys
     ...
     */
    public static void main(String[] args) {
        edu.princeton.cs.algs4.StdDraw.square(.2, .8, .1);
        edu.princeton.cs.algs4.StdDraw.filledSquare(.8, .8, .2);
        edu.princeton.cs.algs4.StdDraw.circle(.8, .2, .2);

        edu.princeton.cs.algs4.StdDraw.setPenColor(edu.princeton.cs.algs4.StdDraw.BOOK_RED);
        edu.princeton.cs.algs4.StdDraw.setPenRadius(.02);
        edu.princeton.cs.algs4.StdDraw.arc(.8, .2, .1, 200, 45);

        // draw a blue diamond
        edu.princeton.cs.algs4.StdDraw.setPenRadius();
        edu.princeton.cs.algs4.StdDraw.setPenColor(edu.princeton.cs.algs4.StdDraw.BOOK_BLUE);
        double[] x = { .1, .2, .3, .2 };
        double[] y = { .2, .3, .2, .1 };
        edu.princeton.cs.algs4.StdDraw.filledPolygon(x, y);

        // text
        edu.princeton.cs.algs4.StdDraw.setPenColor(edu.princeton.cs.algs4.StdDraw.BLACK);
        edu.princeton.cs.algs4.StdDraw.text(0.2, 0.5, "black text");
        edu.princeton.cs.algs4.StdDraw.setPenColor(edu.princeton.cs.algs4.StdDraw.WHITE);
        edu.princeton.cs.algs4.StdDraw.text(0.8, 0.8, "white text");
    }
