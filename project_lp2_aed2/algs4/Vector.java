...
public class Vector { 
     ...
     */
    public double dot(edu.princeton.cs.algs4.Vector that) {
     ...
     * @throws IllegalArgumentException if the dimensions of the two vectors are not equal
     */
    public double distanceTo(edu.princeton.cs.algs4.Vector that) {
        if (this.d != that.d) throw new IllegalArgumentException("Dimensions don't agree");
     ...
     * @throws IllegalArgumentException if the dimensions of the two vectors are not equal
     */
    public edu.princeton.cs.algs4.Vector plus(edu.princeton.cs.algs4.Vector that) {
        if (this.d != that.d) throw new IllegalArgumentException("Dimensions don't agree");
        edu.princeton.cs.algs4.Vector c = new edu.princeton.cs.algs4.Vector(d);
        for (int i = 0; i < d; i++)
     ...
     * @throws IllegalArgumentException if the dimensions of the two vectors are not equal
     */
    public edu.princeton.cs.algs4.Vector minus(edu.princeton.cs.algs4.Vector that) {
        if (this.d != that.d) throw new IllegalArgumentException("Dimensions don't agree");
        edu.princeton.cs.algs4.Vector c = new edu.princeton.cs.algs4.Vector(d);
        for (int i = 0; i < d; i++)
            c.data[i] = this.data[i] - that.data[i];
     ...
     */
    @Deprecated
    public edu.princeton.cs.algs4.Vector times(double alpha) {
        edu.princeton.cs.algs4.Vector c = new edu.princeton.cs.algs4.Vector(d);
        for (int i = 0; i < d; i++)
     ...
     * @return the vector whose value is {@code (alpha * this)}
     */
    public edu.princeton.cs.algs4.Vector scale(double alpha) {
        edu.princeton.cs.algs4.Vector c = new edu.princeton.cs.algs4.Vector(d);
        for (int i = 0; i < d; i++)
            c.data[i] = alpha * data[i];
        return c;
     ...
     */
    public edu.princeton.cs.algs4.Vector direction() {
    ...
    public static void main(String[] args) {
        ...
        edu.princeton.cs.algs4.Vector x = new edu.princeton.cs.algs4.Vector(xdata);
        edu.princeton.cs.algs4.Vector y = new edu.princeton.cs.algs4.Vector(ydata);

        StdOut.println("   x       = " + x);
        StdOut.println("   y       = " + y);

        edu.princeton.cs.algs4.Vector z = x.plus(y);
        StdOut.println("   z       = " + z);
