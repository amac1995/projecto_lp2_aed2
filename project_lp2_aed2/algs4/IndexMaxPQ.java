...
public class IndexMaxPQ<Key extends Comparable<Key>> implements Iterable<Integer> {
    ...
    ***************************************************************************/
    ...
    private class HeapIterator implements Iterator<Integer> {
        ...
        public HeapIterator() {
            copy = new edu.princeton.cs.algs4.IndexMaxPQ<Key>(pq.length - 1);
            for (int i = 1; i <= n; i++)
    ...
    public static void main(String[] args) {
        ...
        edu.princeton.cs.algs4.IndexMaxPQ<String> pq = new edu.princeton.cs.algs4.IndexMaxPQ<String>(strings.length);
