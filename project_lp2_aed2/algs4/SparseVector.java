...
public class SparseVector {
   ...
   /**
     ...
     */
    public double dot(edu.princeton.cs.algs4.SparseVector that) {
     ...
     */
    public edu.princeton.cs.algs4.SparseVector scale(double alpha) {
        edu.princeton.cs.algs4.SparseVector c = new edu.princeton.cs.algs4.SparseVector(d);
     ...
     */
    public edu.princeton.cs.algs4.SparseVector plus(edu.princeton.cs.algs4.SparseVector that) {
        if (this.d != that.d) throw new IllegalArgumentException("Vector lengths disagree");
        edu.princeton.cs.algs4.SparseVector c = new edu.princeton.cs.algs4.SparseVector(d);
   ...
   /**
    ...
    public static void main(String[] args) {
        edu.princeton.cs.algs4.SparseVector a = new edu.princeton.cs.algs4.SparseVector(10);
        edu.princeton.cs.algs4.SparseVector b = new edu.princeton.cs.algs4.SparseVector(10);
        a.put(3, 0.50);
        a.put(9, 0.75);
        a.put(6, 0.11);
        a.put(6, 0.00);
