...
public class BinomialMinPQ<Key> implements Iterable<Key> {
	...
	public void insert(Key key) {
		...
		x.key = key;
		x.order = 0;
		edu.princeton.cs.algs4.BinomialMinPQ<Key> H = new edu.princeton.cs.algs4.BinomialMinPQ<Key>(); //The Comparator oh the H heap is not used
		H.head = x;
	...
	public Key delMin() {
		...
		if (min.child != null) {
			...
			x.sibling = prevx;
			edu.princeton.cs.algs4.BinomialMinPQ<Key> H = new edu.princeton.cs.algs4.BinomialMinPQ<Key>();
			H.head = x;
			head = union(H).head;
		}
		return min.key;
	 ...
	 */
	public edu.princeton.cs.algs4.BinomialMinPQ<Key> union(edu.princeton.cs.algs4.BinomialMinPQ<Key> heap) {
	...
	private class MyIterator implements Iterator<Key> {
		edu.princeton.cs.algs4.BinomialMinPQ<Key> data;
		
		//Constructor clones recursively the elements in the queue
		//It takes linear time
		public MyIterator() {
			data = new edu.princeton.cs.algs4.BinomialMinPQ<Key>(comp);
