...
public class FibonacciMinPQ<Key> implements Iterable<Key> {
	 ...
	 */
	public edu.princeton.cs.algs4.FibonacciMinPQ<Key> union(edu.princeton.cs.algs4.FibonacciMinPQ<Key> that) {
	...
	private class MyIterator implements Iterator<Key> {
		private edu.princeton.cs.algs4.FibonacciMinPQ<Key> copy;
		
		
		//Constructor takes linear time
		public MyIterator() {
			copy = new edu.princeton.cs.algs4.FibonacciMinPQ<Key>(comp);
			insertAll(head);
		}
