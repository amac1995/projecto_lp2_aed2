...
public class SET<Key extends Comparable<Key>> implements Iterable<Key> {
     ...
     */
    public SET(edu.princeton.cs.algs4.SET<Key> x) {
     ...
     */
    public edu.princeton.cs.algs4.SET<Key> union(edu.princeton.cs.algs4.SET<Key> that) {
        if (that == null) throw new IllegalArgumentException("called union() with a null argument");
        edu.princeton.cs.algs4.SET<Key> c = new edu.princeton.cs.algs4.SET<Key>();
        for (Key x : this) {
            c.add(x);
        }
        for (Key x : that) {
     ...
     * @throws IllegalArgumentException if {@code that} is {@code null}
     */
    public edu.princeton.cs.algs4.SET<Key> intersects(edu.princeton.cs.algs4.SET<Key> that) {
    ...
    public boolean equals(Object other) {
        ...
        edu.princeton.cs.algs4.SET that = (edu.princeton.cs.algs4.SET) other;
    ...
    public static void main(String[] args) {
        edu.princeton.cs.algs4.SET<String> set = new edu.princeton.cs.algs4.SET<String>();
        ...
        StdOut.println();
        edu.princeton.cs.algs4.SET<String> set2 = new edu.princeton.cs.algs4.SET<String>(set);
