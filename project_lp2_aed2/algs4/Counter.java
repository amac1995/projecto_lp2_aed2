 ...
 *  @author Kevin Wayne
 */
public class Counter implements Comparable<edu.princeton.cs.algs4.Counter> {
     ...
     */
    @Override
    public int compareTo(edu.princeton.cs.algs4.Counter that) {
    ...
    public static void main(String[] args) { 
        ...
        // create n counters
        edu.princeton.cs.algs4.Counter[] hits = new edu.princeton.cs.algs4.Counter[n];
        for (int i = 0; i < n; i++) {
            hits[i] = new edu.princeton.cs.algs4.Counter("counter" + i);
        }
