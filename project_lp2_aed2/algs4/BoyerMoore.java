...
public class BoyerMoore {
    ...
    public static void main(String[] args) {
        ...
        edu.princeton.cs.algs4.BoyerMoore boyermoore1 = new edu.princeton.cs.algs4.BoyerMoore(pat);
        edu.princeton.cs.algs4.BoyerMoore boyermoore2 = new edu.princeton.cs.algs4.BoyerMoore(pattern, 256);
