...
public class Complex {
     ...
     */
    public edu.princeton.cs.algs4.Complex plus(edu.princeton.cs.algs4.Complex that) {
        double real = this.re + that.re;
        double imag = this.im + that.im;
        return new edu.princeton.cs.algs4.Complex(real, imag);
    }
     ...
     * @return the complex number whose value is {@code (this - that)}
     */
    public edu.princeton.cs.algs4.Complex minus(edu.princeton.cs.algs4.Complex that) {
        double real = this.re - that.re;
        double imag = this.im - that.im;
        return new edu.princeton.cs.algs4.Complex(real, imag);
    }
     ...
     * @return the complex number whose value is {@code (this * that)}
     */
    public edu.princeton.cs.algs4.Complex times(edu.princeton.cs.algs4.Complex that) {
     ...
     */
    public edu.princeton.cs.algs4.Complex scale(double alpha) {
        return new edu.princeton.cs.algs4.Complex(alpha * re, alpha * im);
    }
     ...
     */
    @Deprecated
    public edu.princeton.cs.algs4.Complex times(double alpha) {
        return new edu.princeton.cs.algs4.Complex(alpha * re, alpha * im);
    }
     ...
     */
    public edu.princeton.cs.algs4.Complex conjugate() {
        return new edu.princeton.cs.algs4.Complex(re, -im);
    }
     ...
     */
    public edu.princeton.cs.algs4.Complex reciprocal() {
        double scale = re*re + im*im;
        return new edu.princeton.cs.algs4.Complex(re / scale, -im / scale);
    }
     ...
     * @return the complex number whose value is {@code (this / that)}
     */
    public edu.princeton.cs.algs4.Complex divides(edu.princeton.cs.algs4.Complex that) {
     ...
     */
    public edu.princeton.cs.algs4.Complex exp() {
        return new edu.princeton.cs.algs4.Complex(Math.exp(re) * Math.cos(im), Math.exp(re) * Math.sin(im));
    }
     ...
     */
    public edu.princeton.cs.algs4.Complex sin() {
        return new edu.princeton.cs.algs4.Complex(Math.sin(re) * Math.cosh(im), Math.cos(re) * Math.sinh(im));
    }
     ...
     */
    public edu.princeton.cs.algs4.Complex cos() {
        return new edu.princeton.cs.algs4.Complex(Math.cos(re) * Math.cosh(im), -Math.sin(re) * Math.sinh(im));
    }
     ...
     */
    public edu.princeton.cs.algs4.Complex tan() {
    ...
    public static void main(String[] args) {
        edu.princeton.cs.algs4.Complex a = new edu.princeton.cs.algs4.Complex(5.0, 6.0);
        edu.princeton.cs.algs4.Complex b = new edu.princeton.cs.algs4.Complex(-3.0, 4.0);
