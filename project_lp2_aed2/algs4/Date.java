 ...
 *  @author Kevin Wayne
 */
public class Date implements Comparable<edu.princeton.cs.algs4.Date> {
   ...
   /**
    ...
    public edu.princeton.cs.algs4.Date next() {
        if (isValid(month, day + 1, year))    return new edu.princeton.cs.algs4.Date(month, day + 1, year);
        else if (isValid(month + 1, 1, year)) return new edu.princeton.cs.algs4.Date(month + 1, 1, year);
        else                                  return new edu.princeton.cs.algs4.Date(1, 1, year + 1);
    }
     ...
     */
    public boolean isAfter(edu.princeton.cs.algs4.Date that) {
     ...
     */
    public boolean isBefore(edu.princeton.cs.algs4.Date that) {
        return compareTo(that) < 0;
    }
     ...
     */
    @Override
    public int compareTo(edu.princeton.cs.algs4.Date that) {
    ...
    public boolean equals(Object other) {
        ...
        edu.princeton.cs.algs4.Date that = (edu.princeton.cs.algs4.Date) other;
