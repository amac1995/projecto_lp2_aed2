...
public class SeparateChainingHashST<Key, Value> {
    ...
    private void resize(int chains) {
        edu.princeton.cs.algs4.SeparateChainingHashST<Key, Value> temp = new edu.princeton.cs.algs4.SeparateChainingHashST<Key, Value>(chains);
        for (int i = 0; i < m; i++) {
    ...
    public static void main(String[] args) { 
        edu.princeton.cs.algs4.SeparateChainingHashST<String, Integer> st = new edu.princeton.cs.algs4.SeparateChainingHashST<String, Integer>();
