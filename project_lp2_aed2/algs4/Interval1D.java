...
public class Interval1D {
     ...
     */
    public static final Comparator<edu.princeton.cs.algs4.Interval1D> MIN_ENDPOINT_ORDER  = new MinEndpointComparator();

    /**
     * Compares two intervals by max endpoint.
     */
    public static final Comparator<edu.princeton.cs.algs4.Interval1D> MAX_ENDPOINT_ORDER = new MaxEndpointComparator();

    /**
     * Compares two intervals by length.
     */
    public static final Comparator<edu.princeton.cs.algs4.Interval1D> LENGTH_ORDER = new LengthComparator();
     ...
     */
    public boolean intersects(edu.princeton.cs.algs4.Interval1D that) {
    ...
    public boolean equals(Object other) {
        ...
        edu.princeton.cs.algs4.Interval1D that = (edu.princeton.cs.algs4.Interval1D) other;
    ...
    private static class MinEndpointComparator implements Comparator<edu.princeton.cs.algs4.Interval1D> {
        public int compare(edu.princeton.cs.algs4.Interval1D a, edu.princeton.cs.algs4.Interval1D b) {
    ...
    private static class MaxEndpointComparator implements Comparator<edu.princeton.cs.algs4.Interval1D> {
        public int compare(edu.princeton.cs.algs4.Interval1D a, edu.princeton.cs.algs4.Interval1D b) {
    ...
    private static class LengthComparator implements Comparator<edu.princeton.cs.algs4.Interval1D> {
        public int compare(edu.princeton.cs.algs4.Interval1D a, edu.princeton.cs.algs4.Interval1D b) {
    ...
    public static void main(String[] args) {
        edu.princeton.cs.algs4.Interval1D[] intervals = new edu.princeton.cs.algs4.Interval1D[4];
        intervals[0] = new edu.princeton.cs.algs4.Interval1D(15.0, 33.0);
        intervals[1] = new edu.princeton.cs.algs4.Interval1D(45.0, 60.0);
        intervals[2] = new edu.princeton.cs.algs4.Interval1D(20.0, 70.0);
        intervals[3] = new edu.princeton.cs.algs4.Interval1D(46.0, 55.0);
        ...
        Arrays.sort(intervals, edu.princeton.cs.algs4.Interval1D.MIN_ENDPOINT_ORDER);
        for (int i = 0; i < intervals.length; i++)
            StdOut.println(intervals[i]);
        StdOut.println();

        StdOut.println("Sort by max endpoint");
        Arrays.sort(intervals, edu.princeton.cs.algs4.Interval1D.MAX_ENDPOINT_ORDER);
        for (int i = 0; i < intervals.length; i++)
            StdOut.println(intervals[i]);
        StdOut.println();

        StdOut.println("Sort by length");
        Arrays.sort(intervals, edu.princeton.cs.algs4.Interval1D.LENGTH_ORDER);
        for (int i = 0; i < intervals.length; i++)
            StdOut.println(intervals[i]);
        StdOut.println();
    }
