...
public class StopwatchCPU {
    ...
    public static void main(String[] args) {
        ...
        edu.princeton.cs.algs4.StopwatchCPU timer1 = new edu.princeton.cs.algs4.StopwatchCPU();
        double sum1 = 0.0;
        for (int i = 1; i <= n; i++) {
            sum1 += Math.sqrt(i);
        }
        ...
        edu.princeton.cs.algs4.StopwatchCPU timer2 = new edu.princeton.cs.algs4.StopwatchCPU();
        double sum2 = 0.0;
        for (int i = 1; i <= n; i++) {
            sum2 += Math.pow(i, 0.5);
        }
