...
public class StdArrayIO {
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        double[] a = edu.princeton.cs.algs4.StdArrayIO.readDouble1D();
        edu.princeton.cs.algs4.StdArrayIO.print(a);
        StdOut.println();

        // read and print a matrix of doubles
        double[][] b = edu.princeton.cs.algs4.StdArrayIO.readDouble2D();
        edu.princeton.cs.algs4.StdArrayIO.print(b);
        StdOut.println();

        // read and print a matrix of doubles
        boolean[][] d = edu.princeton.cs.algs4.StdArrayIO.readBoolean2D();
        edu.princeton.cs.algs4.StdArrayIO.print(d);
        StdOut.println();
    }
